...
class SQLTests: XCTestCase {
  ...
  func testSQLToInsertEntry() {
    ...
    let wanted = "INSERT OR REPLACE INTO entry(author, duration, feedid, guid, id, img, length, link, subtitle, summary, title, type, updated, url) VALUES('Daring Fireball / John Gruber', '02:33:05', 1, '5fb7c68f92839fd2fd0006117a391f01', 'http://daringfireball.net/thetalkshow/2015/10/17/ep-133', 'http://daringfireball.net/thetalkshow/graphics/df-logo-1000.png,', 110282964, 'http://daringfireball.net/thetalkshow/2015/10/17/ep-133', 'Andy and Dan talk about the new Microsoft Surface Tablet, the iPad Pro, the new Magic devices, the new iMacs, and more.', 'Serenity Caldwell returns to the show. Topics include this week’s new iMacs; the new “Magic” mouse, trackpad, and keyboard; an overview of Apple Music and iCloud Photos; Facebook’s outrageous background battery usage on iOS; Elon Musk’s gibes on Apple getting into the car industry; and my take on the new *Steve Jobs* movie.', 'Ep. 133: ‘The MacGuffin Tractor’, With Guest Serenity Caldwell', 1, '2015-10-17 19:35:01', 'http://tracking.feedpress.it/link/1068/1894544/228745910-thetalkshow-133a.mp3');"
    XCTAssertEqual(found, wanted)
  }
}
